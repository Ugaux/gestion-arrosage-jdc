...
IniConfig* IniConfig::m_config;

IniConfig::IniConfig(const char* fileName) : SPIFFSIniFile(fileName) {
  m_fileName       = fileName;
  m_ssid[0]        = '\0';
  m_password[0]    = '\0';
  m_moistureSensor = 0;
...
bool IniConfig::getModules(void) {
