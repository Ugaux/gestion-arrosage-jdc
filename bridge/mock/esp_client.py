...
def mock_device_info():
    info = Info(
        id="esp32-a1b2c3",  # MAC derived - String id = "esp32-" + String((uint32_t)ESP.getEfuseMac(), HEX);
        api="v2",
        firmware="2.4.0",  # Allow OTA update checks (because web ui knows latest version)
        hardware="rev_c",
    )
